package co.com.adquirencia.interactions;

import co.com.adquirencia.exceptions.ErrorServicesException;
import co.com.adquirencia.models.TestData;
...
import static co.com.adquirencia.utils.Constant.Constants.*;
        ...
        actor.attemptsTo(
                Get.resource(resource)
                        .with(request -> request.
                                ...
                                .relaxedHTTPSValidation().headers("X-name","Adquirencia").log().all()
                        )
        );
